...
class _stoch_Bound(Protocol):
    ...
    def __call__(self, high: Validated[pd.Series[float], Finite, NotEmpty], low: Validated[pd.Series[float], Finite, NotEmpty], close: Validated[pd.Series[float], Finite, NotEmpty]) -> StochResult: ...
...
class stoch:
    ...
    def __new__(cls, high: Validated[pd.Series[float], Finite, NotEmpty], low: Validated[pd.Series[float], Finite, NotEmpty], close: Validated[pd.Series[float], Finite, NotEmpty], k_period: int = ..., k_slowing: int = ..., d_period: int = ...) -> StochResult: ...
...
class stochf:
    ...
    def __new__(cls, high: Validated[pd.Series[float], Finite, NotEmpty], low: Validated[pd.Series[float], Finite, NotEmpty], close: Validated[pd.Series[float], Finite, NotEmpty], fastk_period: int = ..., fastd_period: int = ...) -> StochResult: ...
