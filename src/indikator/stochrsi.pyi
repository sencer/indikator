...
class _stochrsi_Bound(Protocol):
    ...
    def __call__(self, data: Validated[pd.Series[float], Finite, NotEmpty]) -> StochRSIResult: ...
...
class _stochrsi_Config(_NCMakeableModel[_stochrsi_Bound]):
    ...
    k_period: int
    d_period: int
    def __init__(self, *, rsi_period: int = ..., stoch_period: int = ..., k_period: int = ..., d_period: int = ...) -> None: ...
...
class stochrsi:
    ...
    def __new__(cls, data: Validated[pd.Series[float], Finite, NotEmpty], rsi_period: int = ..., stoch_period: int = ..., k_period: int = ..., d_period: int = ...) -> StochRSIResult: ...
