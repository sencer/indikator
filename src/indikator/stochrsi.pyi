...
class _stochrsi_Bound(Protocol):
    ...
    def __call__(self, data: Validated[pd.Series, Finite, NotEmpty]) -> StochRSIResult: ...
...
class stochrsi:
    ...
    def __new__(cls, data: Validated[pd.Series, Finite, NotEmpty], rsi_period: int = ..., stoch_period: int = ..., k_period: int = ..., d_period: int = ...) -> StochRSIResult: ...
