...
class _opening_range_Bound(Protocol):
    ...
    def __call__(self, high: Validated[pd.Series, Finite, Index(Datetime), NotEmpty], low: Validated[pd.Series, Finite, Index(Datetime), NotEmpty], close: Validated[pd.Series, Finite, Index(Datetime), NotEmpty]) -> OpeningRangeResult: ...
...
class opening_range:
    ...
    def __new__(cls, high: Validated[pd.Series, Finite, Index(Datetime), NotEmpty], low: Validated[pd.Series, Finite, Index(Datetime), NotEmpty], close: Validated[pd.Series, Finite, Index(Datetime), NotEmpty], period_minutes: int = ...) -> OpeningRangeResult: ...
