...
class _obv_Bound(Protocol):
    ...
    def __call__(self, close: Validated[pd.Series, Finite, NotEmpty], volume: Validated[pd.Series, Finite, NotEmpty]) -> OBVResult: ...
...
class obv:
    ...
    def __new__(cls, close: Validated[pd.Series, Finite, NotEmpty], volume: Validated[pd.Series, Finite, NotEmpty]) -> OBVResult: ...
