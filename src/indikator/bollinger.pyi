...
class _bollinger_bands_Bound(Protocol):
    ...
    def __call__(self, data: Validated[pd.Series, Finite, NotEmpty]) -> BollingerBandsResult: ...
...
class bollinger_bands:
    ...
    def __new__(cls, data: Validated[pd.Series, Finite, NotEmpty], window: int = ..., num_std: float = ...) -> BollingerBandsResult: ...
...
class _bollinger_with_bandwidth_Bound(Protocol):
    ...
    @property
    def num_std(self) -> float: ...
    def __call__(self, data: Validated[pd.Series, Finite, NotEmpty]) -> BollingerResult: ...
...
class bollinger_with_bandwidth:
    ...
    window: ClassVar[int]
    num_std: ClassVar[float]
    def __new__(cls, data: Validated[pd.Series, Finite, NotEmpty], window: int = ..., num_std: float = ...) -> BollingerResult: ...
