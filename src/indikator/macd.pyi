...
class _macd_Bound(Protocol):
    ...
    def __call__(self, data: Validated[pd.Series[float], Finite, NotEmpty]) -> MACDResult: ...
...
class macd:
    ...
    def __new__(cls, data: Validated[pd.Series[float], Finite, NotEmpty], fast_period: int = ..., slow_period: int = ..., signal_period: int = ...) -> MACDResult: ...
...
class macdext:
    ...
    def __new__(cls, data: Validated[pd.Series[float], Finite, NotEmpty], fast_period: int = ..., fast_matype: int = ..., slow_period: int = ..., slow_matype: int = ..., signal_period: int = ..., signal_matype: int = ...) -> MACDResult: ...
...
class macdfix:
    ...
    signal_period: ClassVar[int]
    def __new__(cls, data: Validated[pd.Series[float], Finite, NotEmpty], signal_period: int = ...) -> MACDResult: ...
