...
class _linearreg_Bound(Protocol):
    ...
    @property
    def period(self) -> int: ...
    def __call__(self, data: Validated[pd.Series, Finite, NotEmpty]) -> LINEARREGResult: ...
...
class linearreg:
    ...
    period: ClassVar[int]
    def __new__(cls, data: Validated[pd.Series, Finite, NotEmpty], period: int = ...) -> LINEARREGResult: ...

class _linearreg_intercept_Bound(Protocol):
    """Bound function with hyperparameters as attributes."""
    @property
    def period(self) -> int: ...
    def __call__(self, data: Validated[pd.Series, Finite, NotEmpty]) -> LINEARREGInterceptResult: ...
...
class linearreg_intercept:
    ...
    period: ClassVar[int]
    def __new__(cls, data: Validated[pd.Series, Finite, NotEmpty], period: int = ...) -> LINEARREGInterceptResult: ...

class _linearreg_angle_Bound(Protocol):
    """Bound function with hyperparameters as attributes."""
    @property
    def period(self) -> int: ...
    def __call__(self, data: Validated[pd.Series, Finite, NotEmpty]) -> LINEARREGAngleResult: ...
...
class linearreg_angle:
    ...
    period: ClassVar[int]
    def __new__(cls, data: Validated[pd.Series, Finite, NotEmpty], period: int = ...) -> LINEARREGAngleResult: ...

class _linearreg_slope_Bound(Protocol):
    """Bound function with hyperparameters as attributes."""
    @property
    def period(self) -> int: ...
    def __call__(self, data: Validated[pd.Series, Finite, NotEmpty]) -> LINEARREGSlopeResult: ...
...
class linearreg_slope:
    ...
    period: ClassVar[int]
    def __new__(cls, data: Validated[pd.Series, Finite, NotEmpty], period: int = ...) -> LINEARREGSlopeResult: ...
...
class tsf:
    ...
    period: ClassVar[int]
    def __new__(cls, data: Validated[pd.Series, Finite, NotEmpty], period: int = ...) -> TSFResult: ...
