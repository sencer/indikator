...
class _kama_Config(_NCMakeableModel[_kama_Bound]):
    ...
    fast_period: int
    slow_period: int
    def __init__(self, *, period: int = ..., fast_period: int = ..., slow_period: int = ...) -> None: ...
...
class kama:
    ...
    def __new__(cls, data: Validated[pd.Series[float], Finite, NotEmpty], period: int = ..., fast_period: int = ..., slow_period: int = ...) -> IndicatorResult: ...
