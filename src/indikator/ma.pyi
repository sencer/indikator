...
class _ma_Bound(Protocol):
    ...
    @property
    def matype(self) -> int: ...
    def __call__(self, data: Validated[pd.Series[float], Finite, NotEmpty]) -> MAResult: ...
...
class ma:
    ...
    period: ClassVar[int]
    matype: ClassVar[int]
    def __new__(cls, data: Validated[pd.Series[float], Finite, NotEmpty], period: int = ..., matype: int = ...) -> MAResult: ...
