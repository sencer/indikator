...
class _mama_Bound(Protocol):
    ...
    def __call__(self, data: Validated[pd.Series[float], Finite, NotEmpty]) -> MAMAResult: ...
...
class mama:
    ...
    def __new__(cls, data: Validated[pd.Series[float], Finite, NotEmpty], fastlimit: float = ..., slowlimit: float = ...) -> MAMAResult: ...
