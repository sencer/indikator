...
class _legs_Bound(Protocol):
    ...
    def __call__(self, high: Validated[pd.Series[float], Finite, NotEmpty], low: Validated[pd.Series[float], Finite, NotEmpty], close: Validated[pd.Series[float], Finite, NotEmpty]) -> ZigzagLegsResult: ...
...
class _legs_ConfigDict(TypedDict, total=False):
    ...
    Configuration:
        deviation (float)
        method (Literal['percentage.Config | percentage.ConfigDict', 'absolute.Config | absolute.ConfigDict'])
    """
...
class _legs_Config(_NCMakeableModel[_legs_Bound]):
    ...
    deviation: float
    method: Literal['percentage.Config | percentage.ConfigDict', 'absolute.Config | absolute.ConfigDict']
    def __init__(self, *, deviation: float = ..., method: Literal['percentage.Config | percentage.ConfigDict', 'absolute.Config | absolute.ConfigDict'] = ...) -> None: ...
...
class legs:
    ...
    def __new__(cls, high: Validated[pd.Series[float], Finite, NotEmpty], low: Validated[pd.Series[float], Finite, NotEmpty], close: Validated[pd.Series[float], Finite, NotEmpty], deviation: float = ..., method: Literal['percentage', 'absolute'] = ...) -> ZigzagLegsResult: ...
