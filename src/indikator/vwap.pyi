...
class vwap:
    ...
    def __new__(cls, high: Validated[pd.Series[float], Finite, NotEmpty], low: Validated[pd.Series[float], Finite, NotEmpty], close: Validated[pd.Series[float], Finite, NotEmpty], volume: Validated[pd.Series[float], Finite, NotEmpty], anchor: str | pd.Timedelta | int = ...) -> IndicatorResult: ...
...
class _vwap_anchored_Bound(Protocol):
    ...
    def __call__(self, data: Validated[pd.DataFrame, Columns(['high', 'low', 'close', 'volume']), Finite, NotEmpty]) -> IndicatorResult: ...
...
class _vwap_anchored_Config(_NCMakeableModel[_vwap_anchored_Bound]):
    ...
    anchor_index: int | None
    anchor_datetime: pd.Timestamp | str | None
    def __init__(self, *, anchor_index: int | None = ..., anchor_datetime: pd.Timestamp | str | None = ...) -> None: ...
...
class vwap_anchored:
    ...
    def __new__(cls, data: Validated[pd.DataFrame, Columns(['high', 'low', 'close', 'volume']), Finite, NotEmpty], anchor_index: int | None = ..., anchor_datetime: pd.Timestamp | str | None = ...) -> IndicatorResult: ...
