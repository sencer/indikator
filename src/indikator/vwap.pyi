...
class _vwap_Bound(Protocol):
    ...
    def __call__(self, high: Validated[pd.Series, Finite, NotEmpty], low: Validated[pd.Series, Finite, NotEmpty], close: Validated[pd.Series, Finite, NotEmpty], volume: Validated[pd.Series, Finite, NotEmpty]) -> VWAPResult: ...
...
class _vwap_Config(_NCMakeableModel[_vwap_Bound]):
    ...
    anchor: str | pd.Timedelta | int.Config | str | pd.Timedelta | int.ConfigDict
    def __init__(self, *, anchor: str | pd.Timedelta | int.Config | str | pd.Timedelta | int.ConfigDict = ...) -> None: ...
...
class vwap:
    ...
    def __new__(cls, high: Validated[pd.Series, Finite, NotEmpty], low: Validated[pd.Series, Finite, NotEmpty], close: Validated[pd.Series, Finite, NotEmpty], volume: Validated[pd.Series, Finite, NotEmpty], anchor: str | pd.Timedelta | int = ...) -> VWAPResult: ...
