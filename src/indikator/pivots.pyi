...
class _pivots_Bound(Protocol):
    ...
    @property
    def anchor(self) -> str: ...
    def __call__(self, high: Validated[pd.Series[float], Finite, Index(Datetime), NotEmpty], low: Validated[pd.Series[float], Finite, Index(Datetime), NotEmpty], close: Validated[pd.Series[float], Finite, Index(Datetime), NotEmpty]) -> PivotPointsResult: ...

class _pivots_ConfigDict(TypedDict, total=False):
    """Configuration dictionary for pivots.

    Configuration:
        method (Literal['standard.Config | standard.ConfigDict', 'fibonacci.Config | fibonacci.ConfigDict', 'woodie.Config | woodie.ConfigDict', 'camarilla.Config | camarilla.ConfigDict'])
        anchor (str)
    """
...
class _pivots_Config(_NCMakeableModel[_pivots_Bound]):
    ...
    method: Literal['standard.Config | standard.ConfigDict', 'fibonacci.Config | fibonacci.ConfigDict', 'woodie.Config | woodie.ConfigDict', 'camarilla.Config | camarilla.ConfigDict']
    anchor: str
    def __init__(self, *, method: Literal['standard.Config | standard.ConfigDict', 'fibonacci.Config | fibonacci.ConfigDict', 'woodie.Config | woodie.ConfigDict', 'camarilla.Config | camarilla.ConfigDict'] = ..., anchor: str = ...) -> None: ...
...
class pivots:
    ...
    anchor: ClassVar[str]
    def __new__(cls, high: Validated[pd.Series[float], Finite, Index(Datetime), NotEmpty], low: Validated[pd.Series[float], Finite, Index(Datetime), NotEmpty], close: Validated[pd.Series[float], Finite, Index(Datetime), NotEmpty], method: Literal['standard', 'fibonacci', 'woodie', 'camarilla'] = ..., anchor: str = ...) -> PivotPointsResult: ...
