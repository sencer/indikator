...
class sar:
    ...
    def __new__(cls, high: Validated[pd.Series[float], Finite, NotEmpty], low: Validated[pd.Series[float], Finite, NotEmpty], acceleration: float = ..., maximum: float = ...) -> IndicatorResult: ...
...
class sarext:
    ...
    def __new__(cls, high: Validated[pd.Series[float], Finite, NotEmpty], low: Validated[pd.Series[float], Finite, NotEmpty], start_value: float = ..., offset_on_reversal: float = ..., acceleration_init_long: float = ..., acceleration_long: float = ..., acceleration_max_long: float = ..., acceleration_init_short: float = ..., acceleration_short: float = ..., acceleration_max_short: float = ...) -> IndicatorResult: ...
