...
class _cdl_doji_Bound(Protocol):
    ...
    def __call__(self, open_: Validated[pd.Series, Finite, NotEmpty], high: Validated[pd.Series, Finite, NotEmpty], low: Validated[pd.Series, Finite, NotEmpty], close: Validated[pd.Series, Finite, NotEmpty]) -> pd.Series: ...
...
class cdl_doji:
    ...
    def __new__(cls, open_: Validated[pd.Series, Finite, NotEmpty], high: Validated[pd.Series, Finite, NotEmpty], low: Validated[pd.Series, Finite, NotEmpty], close: Validated[pd.Series, Finite, NotEmpty]) -> pd.Series: ...
...
class _cdl_gap_side_by_side_white_Config(_NCMakeableModel[_cdl_gap_side_by_side_white_Bound]):
...
class _cdl_upside_gap_two_crows_Config(_NCMakeableModel[_cdl_upside_gap_two_crows_Bound]):
...
class _cdl_conceal_baby_swallow_Config(_NCMakeableModel[_cdl_conceal_baby_swallow_Bound]):
