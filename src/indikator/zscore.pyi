...
class zscore:
    ...
    period: ClassVar[int]
    def __new__(cls, data: Validated[pd.Series, Finite, NotEmpty], period: int = ...) -> ZScoreResult: ...
...
class _zscore_intraday_Bound(Protocol):
    ...
    def __call__(self, data: Validated[pd.Series, Finite, Index(Datetime), NotEmpty], lookback_days: int | None = ...) -> ZScoreIntradayResult: ...
...
class zscore_intraday:
    ...
    def __new__(cls, data: Validated[pd.Series, Finite, Index(Datetime), NotEmpty], lookback_days: int | None = ..., min_samples: int = ..., epsilon: float = ...) -> ZScoreIntradayResult: ...
