...
class _correl_Bound(Protocol):
    ...
    @property
    def period(self) -> int: ...
    def __call__(self, x: Validated[pd.Series, Finite, NotEmpty], y: Validated[pd.Series, Finite, NotEmpty]) -> CORRELResult: ...
...
class correl:
    ...
    period: ClassVar[int]
    def __new__(cls, x: Validated[pd.Series, Finite, NotEmpty], y: Validated[pd.Series, Finite, NotEmpty], period: int = ...) -> CORRELResult: ...
