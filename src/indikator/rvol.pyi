...
class rvol:  # noqa: N801
  class Config(MakeableModel[Callable[[Validated[pd.Series, NonNegative]], pd.Series]]):
    window: int
    epsilon: float
    def __init__(self, *, window: int = 20, epsilon: float = 1e-09) -> None: ...
    @override
    def make(self) -> Callable[[Validated[pd.Series, NonNegative]], pd.Series]: ...
...
class rvol_intraday:  # noqa: N801
  class Config(
    MakeableModel[
      Callable[
        [Validated[pd.Series, NonNegative, Index[Datetime]], int | None], pd.Series
      ]
    ]
  ):
    min_samples: int
