...
class rvol:
    ...
    def __new__(cls, data: Validated[pd.Series[float], Finite, NotEmpty], window: int = ..., epsilon: float = ...) -> IndicatorResult: ...
...
class _rvol_intraday_Bound(Protocol):
    ...
    @property
    def epsilon(self) -> float: ...
    def __call__(self, data: Validated[pd.Series[float], Finite, Index(Datetime), NotEmpty]) -> IndicatorResult: ...
...
class _rvol_intraday_Config(_NCMakeableModel[_rvol_intraday_Bound]):
    ...
    min_samples: int
    epsilon: float
    def __init__(self, *, lookback_days: int | None = ..., min_samples: int = ..., epsilon: float = ...) -> None: ...
...
class rvol_intraday:
    ...
    epsilon: ClassVar[float]
    def __new__(cls, data: Validated[pd.Series[float], Finite, Index(Datetime), NotEmpty], lookback_days: int | None = ..., min_samples: int = ..., epsilon: float = ...) -> IndicatorResult: ...
