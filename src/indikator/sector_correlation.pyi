...
class _sector_correlation_Bound(Protocol):
    ...
    @property
    def period(self) -> int: ...
    def __call__(self, stock_data: Validated[pd.Series, Finite, NotEmpty], sector_data: Validated[pd.Series, Finite, NotEmpty]) -> SectorCorrelationResult: ...
...
class sector_correlation:
    ...
    period: ClassVar[int]
    def __new__(cls, stock_data: Validated[pd.Series, Finite, NotEmpty], sector_data: Validated[pd.Series, Finite, NotEmpty], period: int = ...) -> SectorCorrelationResult: ...
