...
class _mavp_Bound(Protocol):
    ...
    @property
    def matype(self) -> int: ...
    def __call__(self, data: Validated[pd.Series[float], NotEmpty], periods: Validated[pd.Series[float], NotEmpty]) -> pd.Series: ...
...
class _mavp_Config(_NCMakeableModel[_mavp_Bound]):
    ...
    maxperiod: int
    matype: int
    def __init__(self, *, minperiod: int = ..., maxperiod: int = ..., matype: int = ...) -> None: ...
...
class mavp:
    ...
    matype: ClassVar[int]
    def __new__(cls, data: Validated[pd.Series[float], NotEmpty], periods: Validated[pd.Series[float], NotEmpty], minperiod: int = ..., maxperiod: int = ..., matype: int = ...) -> pd.Series: ...
