...
class _min_val_Bound(Protocol):
    ...
    @property
    def period(self) -> int: ...
    def __call__(self, data: Validated[pd.Series[float], Finite, NotEmpty]) -> pd.Series: ...
...
class min_val:
    ...
    period: ClassVar[int]
    def __new__(cls, data: Validated[pd.Series[float], Finite, NotEmpty], period: int = ...) -> pd.Series: ...
...
class _minmax_Bound(Protocol):
    ...
    @property
    def period(self) -> int: ...
    def __call__(self, data: Validated[pd.Series[float], Finite, NotEmpty]) -> tuple[pd.Series, pd.Series]: ...
...
class minmax:
    ...
    period: ClassVar[int]
    def __new__(cls, data: Validated[pd.Series[float], Finite, NotEmpty], period: int = ...) -> tuple[pd.Series, pd.Series]: ...
