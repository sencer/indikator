...
class _atr_intraday_Bound(Protocol):
    ...
    def __call__(self, data: Validated[pd.DataFrame, Columns(['high', 'low', 'close']), Finite, Index(Datetime), NotEmpty]) -> IndicatorResult: ...
...
class _atr_intraday_Config(_NCMakeableModel[_atr_intraday_Bound]):
    ...
    lookback_days: int | None
    min_samples: int
    def __init__(self, *, lookback_days: int | None = ..., min_samples: int = ...) -> None: ...
...
class atr_intraday:
    ...
    def __new__(cls, data: Validated[pd.DataFrame, Columns(['high', 'low', 'close']), Finite, Index(Datetime), NotEmpty], lookback_days: int | None = ..., min_samples: int = ...) -> IndicatorResult: ...
