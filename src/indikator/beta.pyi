...
class _beta_statistical_Bound(Protocol):
    ...
    @property
    def period(self) -> int: ...
    def __call__(self, x: Validated[pd.Series, Finite, NotEmpty], y: Validated[pd.Series, Finite, NotEmpty]) -> BETAResult: ...
...
class beta_statistical:
    ...
    period: ClassVar[int]
    def __new__(cls, x: Validated[pd.Series, Finite, NotEmpty], y: Validated[pd.Series, Finite, NotEmpty], period: int = ...) -> BETAResult: ...
