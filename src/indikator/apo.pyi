...
class _apo_Bound(Protocol):
    ...
    def __call__(self, data: Validated[pd.Series, Finite, NotEmpty], matype: int = ...) -> APOResult: ...
...
class apo:
    ...
    def __new__(cls, data: Validated[pd.Series, Finite, NotEmpty], matype: int = ..., fast_period: int = ..., slow_period: int = ...) -> APOResult: ...
